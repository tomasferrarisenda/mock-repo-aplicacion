...
export default (function () {
   'use strict';
	...
	module.init = function (module) {
		...
		module.factory('PacienteStorageHelperService', PacienteStorageHelperService);

		PacienteStorageHelperService.$inject = ['DotService', 'Logger', 'StorageService'];
		
		function PacienteStorageHelperService (DotService, $log, StorageService) {

			$log = $log.getInstance('PacienteStorageHelperService');
