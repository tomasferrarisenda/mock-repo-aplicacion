...
import saGrupoPrestacionListTemplate = require('../templates/sa-grupo-prestacion-list.html');
...
export default (function () {
    ...
    module.init = function (module) {
        ...
        module.directive('saGrupoPrestacionList', saGrupoPrestacionList);

        saGrupoPrestacionList.$inject = ['$log', '$filter'];

        function saGrupoPrestacionList($log, $filter) {
            ...
            return {
                ...
                template: saGrupoPrestacionListTemplate,
                link: link
            };
            ...
            function link(scope, element, attrs, controller) {
                ...
                function activate() {
                    //scope.paginacionPrestacion.currentPage = 1;
