...
export default (function () {
	...
	module.init = function (module) {
		...
		DimensionableEditTplController.$inject = ['Logger', '$state', 'ModalService', 'condicion', '$q', 'ConvenioDataService', '$uibModalInstance', '$scope', 'OPERADOR_CONDICION', '$filter', 'idFinanciador', 'tipoValorConsecuencia', 'CONSECUENCIA_VALOR', 'TIPO_OPERABLE'];

		function DimensionableEditTplController($log, $state, ModalService, condicion, $q, ConvenioDataService, $uibModalInstance, $scope, OPERADOR_CONDICION, $filter, idFinanciador, tipoValorConsecuencia, CONSECUENCIA_VALOR, TIPO_OPERABLE) {
			...
			function completarValorDto(nuevoValorDto, elemento) {
				...
				nuevoValorDto.IdTipoOperable = TIPO_OPERABLE.DIMENSIONABLE;
				nuevoValorDto.IdTipoValor = 0;
			}
