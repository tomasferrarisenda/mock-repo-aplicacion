...
export default (function () {
	...
	module.init = function (ngModule) {
		...
		ngModule.directive('fwBtnOk', fwButtonOk);
		ngModule.directive('saBtnOk', fwButtonOk);

		fwButtonOk.$inject = ['$log', '$compile'];
		function fwButtonOk ($log, $compile) {
			return {
				restrict : 'A',
				link: link
			};
