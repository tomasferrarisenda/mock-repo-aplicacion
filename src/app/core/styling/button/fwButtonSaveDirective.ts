...
export default (function () {
	...
	module.init = function (ngModule) {
		...
		ngModule.directive('fwBtnSave', fwButtonSave);
		ngModule.directive('saBtnSave', fwButtonSave);

		fwButtonSave.$inject = ['$log', '$compile'];
		function fwButtonSave ($log, $compile) {
			return {
				restrict : 'A',
				link: link
			};
